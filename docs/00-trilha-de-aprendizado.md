...
linguagem, biblioteca padrão, concorrência e backend. Os exercícios e projetos
ficam em [Práticas e projetos de Go](01-praticas-e-projetos.md).
...
| 1. Fundamentos | 1–5 |
| 2. Dados e memória | 6–10 |
| 3. Abstração idiomática | 11–14 |
| 4. Código confiável | 15–16 |
| 5. Concorrência | 17–19 |
| 6. Execução e diagnóstico | 20 |
| 7. Backend | 21 |
...
Material: [Toolchain e comandos úteis](01-toolchain.md).
...
- [x] Escopo de pacote, função e bloco e Shadowing de variáveis.
